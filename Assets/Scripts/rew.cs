...
public class rew : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
...
    void Awake()
	...
	public void OnUnityAdsAdLoaded(string androidAdUnitId)
	{
		Debug.Log("Ad Loaded: " + androidAdUnitId);

		if (_androidAdUnitId.Equals(androidAdUnitId))
		{
